...
exports.detectLanguage = function detectLanguage(text) {
  if (!text) return 'en';
...
exports.generateStructuredAiResponse = function generateStructuredAiResponse(query, persona, lang, isSimpleMode = false) {
