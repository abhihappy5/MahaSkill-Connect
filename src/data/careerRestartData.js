export const mockRestartProfile = {
  id: "restart-10842",
  name: "Pooja Patil",
  nameMr: "पूजा पाटील",
  nameHi: "पूजा पाटिल",
...
export const transferableSkillsProfiles = [
  {
    id: "retail-to-office",
...
export const personalizedLearningSteps = [
  {
    step: 1,
...
export const restartJobsUnlocked = [
  {
    id: "unlocked-1",
